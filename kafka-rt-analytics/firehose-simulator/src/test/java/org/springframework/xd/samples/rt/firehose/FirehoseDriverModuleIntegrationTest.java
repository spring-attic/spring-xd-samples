 ...
 */
public class FirehoseDriverModuleIntegrationTest {
	...
	public void testDefault() {
		SingleNodeProcessingChainConsumer chain = chainConsumer(application, "firehoseStream", "firehose");
		Object payload = chain.receivePayload(RECEIVE_TIMEOUT);
		assertTrue(payload instanceof AppEvent);
		chain.destroy();
	}

	@Test
	public void testWithAppDistribution() {
		SingleNodeProcessingChainConsumer chain = chainConsumer(application, "firehoseStreamAppDist",
				"firehose --sourceDistribution=80,10,5,5");
	...
	@Test
	public void testWithEventDistribution() {
		SingleNodeProcessingChainConsumer chain = chainConsumer(application, "firehoseStreamEventDist",
				"firehose --eventDistribution=98,1,1");
