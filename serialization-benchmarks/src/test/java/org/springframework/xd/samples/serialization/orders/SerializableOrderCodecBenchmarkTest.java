...
/**
 * Sample Benchmark for Order domain. Domain objects implement kryo.Serializable.
 *
 * @author David Turanski
 */
public class SerializableOrderCodecBenchmarkTest extends AbstractCodecBenchmarkTest {
	@Override
	protected PojoCodec getPojoCodec() {
		return new PojoCodec((KryoRegistrar)null, false);
	}

	@Override
	protected Object getObjectToSerialize() {
		// Use serializable instances
		return OrderCreator.getInstance(true);
	}
}
